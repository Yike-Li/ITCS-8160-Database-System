...
CREATE TABLE `campus_eats_fall2020`.`rating` (
  `rating_id` INT(11) NOT NULL AUTO_INCREMENT,
  `overall_exp` INT(11) NULL,
  `order_id` INT(11) NULL,
  PRIMARY KEY (`rating_id`),
  KEY `fk_order_rating` (`order_id`),
  CONSTRAINT `fk_order_rating` FOREIGN KEY (`order_id`) REFERENCES `campus_eats_fall2020`.`order` (`order_id`)
) ENGINE = InnoDB;
-- Dumping data for table `rating`
LOCK TABLES `rating` WRITE;
/*!40000 ALTER TABLE `rating` DISABLE KEYS */;
INSERT INTO `rating` (`rating_id`,`overall_exp`,`order_id`) VALUES (1,4,1),(2,2,2),(3,4,3),(4,5,4),(5,1,5),(6,4,6),(7,2,7),(8,2,8),(9,3,9),(10,5,10),(11,3,11),(12,4,12),(13,2,13),(14,5,14),(15,1,15),(16,4,16),(17,4,17),(18,2,18),(19,5,19),(20,5,20),(21,5,21),(22,2,22),(23,4,23),(24,3,24),(25,5,25);
INSERT INTO `rating` (`rating_id`,`overall_exp`,`order_id`) VALUES (26,5,26),(27,4,27),(28,5,28),(29,3,29),(30,5,30),(31,3,31),(32,1,32),(33,4,33),(34,2,34),(35,2,35),(36,3,36),(37,4,37),(38,5,38),(39,2,39),(40,5,40),(41,2,41),(42,4,42),(43,3,43),(44,4,44),(45,3,45),(46,5,46),(47,1,47),(48,5,48),(49,4,49),(50,4,50);
INSERT INTO `rating` (`rating_id`,`overall_exp`,`order_id`) VALUES (51,4,51),(52,1,52),(53,5,53),(54,1,54),(55,3,55),(56,2,56),(57,4,57),(58,3,58),(59,3,59),(60,1,60),(61,1,61),(62,2,62),(63,3,63),(64,5,64),(65,3,65),(66,4,66),(67,2,67),(68,1,68),(69,1,69),(70,2,70),(71,1,71),(72,4,72),(73,2,73),(74,5,74),(75,1,75);
INSERT INTO `rating` (`rating_id`,`overall_exp`,`order_id`) VALUES (76,3,76),(77,5,77),(78,1,78),(79,3,79),(80,2,80),(81,1,81),(82,2,82),(83,3,83),(84,5,84),(85,4,85),(86,1,86),(87,4,87),(88,2,88),(89,3,89),(90,3,90),(91,1,91),(92,1,92),(93,1,93),(94,3,94),(95,2,95),(96,3,96),(97,2,97),(98,2,98),(99,3,99),(100,3,100);
/*!40000 ALTER TABLE `rating` ENABLE KEYS */;
UNLOCK TABLES;

-- -----------------------------------------------------
-- Table `campus_eats_fall2020`.`restaurant_rating`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurant_rating`;
CREATE TABLE `campus_eats_fall2020`.`restaurant_rating` (
  `rating_id` INT(11) NOT NULL,
  `food_rating` INT(11) NULL,
  `price_rating` INT(11) NULL,
  `feedback` VARCHAR(200) NULL,
  PRIMARY KEY (`rating_id`),
  KEY `fk_restaurant_rating` (`rating_id`),
  CONSTRAINT `fk_restaurant_rating` FOREIGN KEY (`rating_id`) REFERENCES `campus_eats_fall2020`.`rating` (`rating_id`)
) ENGINE = InnoDB;
...
INSERT INTO `restaurant_rating` (`rating_id`,`food_rating`,`price_rating`,`feedback`) VALUES (1,5,2,"lacinia mattis."),(2,1,1,"pretium et,"),(3,3,5,"et netus et"),(4,4,1,"pede ac"),(5,4,3,"hendrerit consectetuer, cursus et,"),(6,4,5,"in sodales"),(7,5,1,"ut dolor"),(8,4,3,"pellentesque. Sed dictum. Proin"),(9,2,1,"in faucibus orci luctus"),(10,3,5,"Maecenas ornare"),(11,5,2,"erat, in consectetuer ipsum"),(12,5,3,"sit amet orci. Ut"),(13,1,4,"tempor bibendum. Donec felis"),(14,5,3,"sapien. Cras"),(15,4,1,"dui nec urna"),(16,1,5,"Ut semper pretium neque."),(17,2,5,"lobortis risus. In"),(18,2,3,"metus. In lorem. Donec"),(19,3,5,"ac turpis egestas. Fusce"),(20,4,1,"tincidunt orci"),(21,5,3,"quam, elementum at,"),(22,4,2,"interdum feugiat."),(23,3,4,"a odio semper"),(24,2,2,"scelerisque mollis. Phasellus libero"),(25,4,3,"erat semper rutrum.");
INSERT INTO `restaurant_rating` (`rating_id`,`food_rating`,`price_rating`,`feedback`) VALUES (26,3,4,"Fusce dolor quam, elementum"),(27,5,2,"convallis convallis dolor."),(28,2,4,"amet, faucibus ut,"),(29,2,4,"ac ipsum. Phasellus vitae"),(30,2,1,"ac sem ut"),(31,4,5,"Vivamus sit amet"),(32,3,1,"consequat dolor vitae dolor."),(33,2,3,"eget mollis"),(34,4,3,"Vestibulum ut"),(35,4,5,"enim, condimentum eget, volutpat"),(36,4,3,"risus. Duis a"),(37,1,1,"et, lacinia"),(38,2,4,"odio. Phasellus at augue"),(39,1,4,"dolor, nonummy ac, feugiat"),(40,1,1,"fames ac turpis egestas."),(41,2,3,"nisi magna sed dui."),(42,5,1,"purus gravida sagittis. Duis"),(43,4,2,"eget nisi dictum augue"),(44,1,3,"Nulla tempor augue"),(45,5,1,"In condimentum."),(46,1,5,"euismod ac, fermentum vel,"),(47,5,1,"risus varius orci,"),(48,5,3,"nisl arcu iaculis enim,"),(49,4,1,"odio. Phasellus at augue"),(50,5,5,"est. Nunc ullamcorper,");
INSERT INTO `restaurant_rating` (`rating_id`,`food_rating`,`price_rating`,`feedback`) VALUES (51,3,2,"ac metus"),(52,1,5,"quam. Pellentesque habitant"),(53,3,2,"velit. Pellentesque ultricies dignissim"),(54,1,1,"orci sem eget massa."),(55,2,2,"tellus. Nunc lectus pede,"),(56,2,1,"diam dictum"),(57,4,5,"urna et arcu imperdiet"),(58,4,4,"diam eu"),(59,3,1,"montes, nascetur ridiculus"),(60,2,1,"augue eu tellus. Phasellus"),(61,1,1,"amet diam"),(62,3,1,"Curabitur dictum."),(63,4,2,"dapibus gravida."),(64,1,3,"metus. In lorem."),(65,4,5,"faucibus ut,"),(66,1,3,"Vivamus euismod urna."),(67,5,1,"non, luctus sit"),(68,2,1,"penatibus et magnis dis"),(69,4,1,"Aliquam tincidunt,"),(70,4,1,"auctor quis, tristique ac,"),(71,3,3,"habitant morbi tristique"),(72,4,5,"lorem, eget mollis lectus"),(73,3,5,"non, lobortis quis, pede."),(74,3,2,"interdum libero dui nec"),(75,2,4,"et, rutrum non, hendrerit");
INSERT INTO `restaurant_rating` (`rating_id`,`food_rating`,`price_rating`,`feedback`) VALUES (76,5,1,"Proin sed"),(77,4,5,"aliquet diam."),(78,4,5,"lorem, vehicula et,"),(79,3,1,"augue, eu tempor erat"),(80,2,4,"nostra, per inceptos"),(81,2,4,"massa rutrum"),(82,5,1,"Curae; Donec tincidunt."),(83,3,1,"risus. Nulla eget metus"),(84,1,2,"consequat auctor, nunc"),(85,4,2,"Nulla interdum. Curabitur"),(86,3,2,"pretium aliquet, metus urna"),(87,5,4,"massa rutrum magna."),(88,1,4,"lacinia. Sed congue,"),(89,2,4,"ornare, libero at"),(90,2,3,"lorem, sit amet ultricies"),(91,1,3,"rutrum non, hendrerit"),(92,3,5,"in lobortis"),(93,3,2,"tempor diam"),(94,2,2,"urna justo faucibus"),(95,3,5,"euismod et, commodo"),(96,3,3,"lacus vestibulum lorem, sit"),(97,4,2,"Nunc pulvinar arcu"),(98,1,4,"primis in faucibus"),(99,3,4,"Ut tincidunt"),(100,5,2,"lorem, luctus");
...
CREATE TABLE `campus_eats_fall2020`.`driver_rating` (
  `rating_id` INT(11) NOT NULL,
  `courteous_rating` INT(11) NULL,
  `ontime_rating` INT(11) NULL,
  `feedback` VARCHAR(200) NULL,
  PRIMARY KEY (`rating_id`),
  KEY `fk_driver_rating` (`rating_id`),
  CONSTRAINT `fk_driver_rating` FOREIGN KEY (`rating_id`) REFERENCES `campus_eats_fall2020`.`rating` (`rating_id`)
) ENGINE = InnoDB;
-- Dumping data for table `driver_rating`
LOCK TABLES `driver_rating` WRITE;
/*!40000 ALTER TABLE `driver_rating` DISABLE KEYS */;
INSERT INTO `driver_rating` (`rating_id`,`courteous_rating`,`ontime_rating`,`feedback`) VALUES (1,1,1,"vitae dolor. Donec fringilla."),(2,2,5,"purus. Duis elementum,"),(3,2,1,"orci, adipiscing non, luctus"),(4,1,4,"iaculis aliquet"),(5,5,2,"nibh. Quisque nonummy ipsum"),(6,1,3,"vel quam"),(7,3,1,"accumsan convallis,"),(8,1,1,"orci lobortis augue"),(9,4,3,"Duis cursus,"),(10,1,2,"Nunc mauris. Morbi"),(11,4,5,"neque non"),(12,4,4,"natoque penatibus et magnis"),(13,3,4,"semper egestas,"),(14,2,3,"a neque. Nullam"),(15,3,3,"non, bibendum sed,"),(16,2,3,"Curae; Donec"),(17,5,4,"molestie in, tempus eu,"),(18,5,4,"adipiscing elit. Aliquam auctor,"),(19,1,4,"Integer urna."),(20,4,3,"non ante"),(21,5,2,"tristique pharetra. Quisque ac"),(22,5,1,"dictum placerat, augue."),(23,3,4,"nisi magna sed"),(24,5,3,"arcu ac"),(25,5,1,"nibh sit amet");
INSERT INTO `driver_rating` (`rating_id`,`courteous_rating`,`ontime_rating`,`feedback`) VALUES (26,5,4,"rutrum urna, nec"),(27,3,3,"nonummy ut, molestie"),(28,5,2,"nascetur ridiculus"),(29,1,3,"amet massa."),(30,2,5,"Fusce feugiat. Lorem"),(31,1,4,"suscipit, est ac facilisis"),(32,1,4,"Mauris quis turpis vitae"),(33,5,4,"Nunc mauris"),(34,2,3,"dolor dapibus gravida. Aliquam"),(35,5,5,"rutrum lorem ac risus."),(36,1,4,"mauris, rhoncus"),(37,1,3,"ornare, lectus ante"),(38,2,5,"eu, placerat eget,"),(39,4,4,"dapibus rutrum, justo."),(40,5,4,"urna suscipit nonummy. Fusce"),(41,3,5,"suscipit, est"),(42,5,5,"nisl elementum purus, accumsan"),(43,5,1,"Ut sagittis"),(44,4,1,"Vestibulum accumsan"),(45,2,5,"amet nulla. Donec"),(46,1,1,"sem magna nec"),(47,4,3,"Proin dolor. Nulla"),(48,1,2,"enim. Etiam imperdiet"),(49,3,2,"in consectetuer"),(50,2,3,"et, commodo at, libero.");
INSERT INTO `driver_rating` (`rating_id`,`courteous_rating`,`ontime_rating`,`feedback`) VALUES (51,5,2,"dis parturient montes, nascetur"),(52,2,5,"eu turpis. Nulla"),(53,4,4,"Sed eu"),(54,3,3,"Donec fringilla. Donec"),(55,2,4,"imperdiet non,"),(56,1,1,"interdum. Nunc sollicitudin commodo"),(57,5,5,"magnis dis parturient"),(58,3,4,"dolor sit"),(59,5,4,"molestie pharetra"),(60,4,2,"senectus et netus et"),(61,1,2,"lacus. Nulla tincidunt, neque"),(62,5,3,"Etiam ligula"),(63,2,3,"purus. Maecenas libero est,"),(64,2,3,"a, facilisis non,"),(65,2,1,"bibendum fermentum metus. Aenean"),(66,3,5,"et, rutrum eu,"),(67,1,5,"Class aptent taciti"),(68,4,2,"egestas. Aliquam fringilla"),(69,1,1,"aliquet molestie"),(70,3,2,"In faucibus. Morbi"),(71,2,5,"Cum sociis natoque"),(72,5,2,"mus. Proin"),(73,5,3,"dolor egestas rhoncus."),(74,4,2,"Maecenas libero est,"),(75,5,5,"nisl. Quisque");
INSERT INTO `driver_rating` (`rating_id`,`courteous_rating`,`ontime_rating`,`feedback`) VALUES (76,5,5,"ac, eleifend vitae,"),(77,3,5,"sodales. Mauris blandit"),(78,3,1,"penatibus et magnis"),(79,5,3,"cursus et, magna. Praesent"),(80,1,4,"In faucibus. Morbi"),(81,4,1,"orci. Ut sagittis lobortis"),(82,1,2,"Vivamus nibh dolor,"),(83,1,4,"rutrum, justo. Praesent"),(84,4,4,"eu nibh vulputate"),(85,5,1,"Mauris blandit enim"),(86,3,3,"morbi tristique"),(87,2,3,"justo. Praesent luctus. Curabitur"),(88,1,3,"sagittis augue,"),(89,4,4,"Nulla interdum."),(90,1,3,"diam nunc, ullamcorper eu,"),(91,5,3,"amet ornare lectus justo"),(92,5,5,"diam luctus"),(93,1,3,"Integer urna."),(94,2,4,"Phasellus elit pede, malesuada"),(95,2,4,"non enim."),(96,2,4,"enim mi"),(97,3,5,"ligula tortor, dictum"),(98,5,4,"elit. Nulla facilisi. Sed"),(99,3,5,"tortor. Nunc commodo auctor"),(100,4,4,"metus urna");
...
-- YL create views
DROP VIEW IF EXISTS `driver_name_rating`;
CREATE VIEW `driver_name_rating` AS 
SELECT person_name as 'driver name', 
avg(overall_exp) as 'Average overall rating', avg(courteous_rating) as 'Average courteous rating', avg(ontime_rating) as 'Average on-time rating'
from driver
join student using (student_id)
join person using (person_id)
join campus_eats_fall2020.order using (driver_id)
join rating using (order_id)
join driver_rating using (rating_id)
group by person_name
order by person_name;

DROP VIEW IF EXISTS `restaurant_name_rating`;
CREATE VIEW `restaurant_name_rating` AS 
SELECT restaurant_name as 'restaurant name', location as address,
avg(overall_exp) as 'Average overall rating', avg(food_rating) as 'Average food rating', avg(price_rating) as 'Average price rating'
from restaurant
join campus_eats_fall2020.order using (restaurant_id)
join rating using (order_id)
join restaurant_rating using (rating_id)
group by restaurant_name
order by restaurant_name;

DROP VIEW IF EXISTS `person_order_rating`;
CREATE VIEW `person_order_rating` AS 
SELECT person_name as 'orderer name', 
avg(d.overall_exp) as 'Avg overall driver rating', avg(r.overall_exp) as 'Avg overall restaurant rating', 
avg(courteous_rating) as 'Avg courteous rating', avg(ontime_rating) as 'Avg on-time rating',
avg(food_rating) as 'Avg food rating', avg(price_rating) as 'Avg price rating'
from person
join campus_eats_fall2020.order using (person_id)
join (select * from driver_rating join rating using (rating_id)) d using (order_id)
join (select * from restaurant_rating join rating using (rating_id)) r using (order_id)
group by person_name
order by person_name;